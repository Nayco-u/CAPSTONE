...
#define DUTY_MAX          1023  // 61.8% de 1023 (modo boost)
#define DUTY_MIN          0
...
// Pines para balanceo de celdas
#define TRANSISTOR_BALANCEO_1  32
#define TRANSISTOR_BALANCEO_2  33

// Umbral de voltaje para activar balanceo (en mV)
#define DELTA_SOC_BALANCEO 500 // balancear si la diferencia de SOC es mayor a 5%
...
// PWM
#define MPPT_PWM_PIN         27
#define MPPT_PWM_CHANNEL     LEDC_CHANNEL_5
#define MPPT_PWM_FREQ        20000
#define MPPT_PWM_RESOLUTION  10  // 10 bits

// P&O Config
#define MPPT_DUTY_MIN        0
#define MPPT_DUTY_MAX        900
#define MPPT_DUTY_STEP       20
#define MPPT_UPDATE_INTERVAL_MS 1000
#define MPPT_SENSIBILIDAD    0.103
